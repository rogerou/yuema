...
public class MainActivity extends ActivityBase implements OnClickListener {
	...
	TextView tv_info;
	ListView listView;
	Button btn_relation_qq, btn_relation_weibo, btn_logout, btn_remove_qq,
			btn_remove_weibo, btn_push;
	ImageView iv_back;
	...
	private void associateUser(JSONObject totalJson) {
		BmobUser.associateWithAuthDate(this,
				BmobUser.getCurrentUser(getApplicationContext()), totalJson,
				new UpdateListener() {
	...
	public void onClick(View arg0) {
		...
		if (arg0 == btn_relation_weibo) {
			...
			finish();
		} else if (arg0 == btn_push) {
			bmobPushManager.pushMessageAll("好的");
		}
	}
